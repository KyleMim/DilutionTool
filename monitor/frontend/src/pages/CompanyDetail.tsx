    ...
    <div className="flex h-full">
      ...
      {!chatOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-12 h-12 rounded-full bg-accent hover:bg-accent-hover text-white shadow-lg flex items-center justify-center transition-all z-10 group"
