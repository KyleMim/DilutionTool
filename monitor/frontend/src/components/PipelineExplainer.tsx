...
const STEPS = [
  ...
  },
  {
    title: "Score & Rank",
    detail:
      "After enrichment, scored using 6 weighted metrics: Share CAGR (25%) measures annual share dilution; FCF Burn (20%) tracks cash consumption; Offering Frequency (20%) counts dilutive events; SBC/Revenue (15%) measures compensation dilution; Cash Runway (10%) estimates burn time; ATM Score (10%) assesses active shelf risk. Companies ranked by percentile: top 10% = Critical, next 40% = Watchlist, bottom 50% = Monitoring.",
  },
];
    ...
    <div className="bg-surface/50 border border-border/50 rounded-lg mb-4">
      ...
      >
        ...
        <span className="flex-1 text-left">
          ...
          Composite score from 6 weighted metrics: Share CAGR (25%), FCF Burn (20%), Offerings (20%), SBC (15%), Runway (10%), ATM (10%)
        </span>
        <svg
